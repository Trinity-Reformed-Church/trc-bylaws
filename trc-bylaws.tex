...
\date{Amended on October 22, 2023}
...
Trinity Reformed Church was established on October 27, 1996. These bylaws were last amended on October 30, 2022.
...
\addcontentsline{toc}{section}{The King and Head of the Church}
...
\addcontentsline{toc}{section}{Preliminary Principles}
...
\addcontentsline{toc}{section}{1. Name}
...
\addcontentsline{toc}{section}{2. Constitution}
...
\addcontentsline{toc}{section}{3. Organization and Incorporation}
...
\addcontentsline{toc}{section}{4. Purpose and Limitations}
...
\addcontentsline{toc}{section}{5. Location of Office}
...
\addcontentsline{toc}{section}{6. Membership}
...
\item
  Voting members of the congregation shall be only those communicant members who are at least eighteen years old, in good standing in the Church, and have signed the Membership Commitment Form as an adult. (``Good standing'' means that a member is not presently under the censure of suspension or deposition.) Any voting member in attendance at a duly called meeting shall be entitled to one vote on matters brought before the congregation. Voting by proxy shall not be permitted.
\item
...
\addcontentsline{toc}{section}{7. Elders and Deacons}
...
\addcontentsline{toc}{section}{8. Pastor}
...
\addcontentsline{toc}{section}{9. Board of Elders (Board of Directors)}
...
\addcontentsline{toc}{section}{10. Board of Deacons}
...
\addcontentsline{toc}{section}{11. Congregational Meetings}
...
\addcontentsline{toc}{section}{12. Church Records}
...
\addcontentsline{toc}{section}{13. Biblical Counseling}
...
\addcontentsline{toc}{section}{14. Confidentiality}
...
\addcontentsline{toc}{section}{15. Conflict Resolution}
...
\addcontentsline{toc}{section}{16. Church Discipline}
...
\addcontentsline{toc}{section}{17. Ownership and Distribution of Property}
...
\addcontentsline{toc}{section}{18. Indemnification of Officers}
...
\addcontentsline{toc}{section}{19. Committees}
...
\addcontentsline{toc}{section}{20. Rules of Order}
...
\addcontentsline{toc}{section}{21. Amendment of Bylaws}
...
\addcontentsline{toc}{subsection}{Excerpt from \emph{Biblical Church Discipline} by Daniel E. Wray}
...
\tightlist
\item
  \textbf{Current version:} Amendment to Bylaws sections 6.b and 6.d regarding the requirement that members sign the Membership Commitment Form as adults. The amendment was approved by the congregation on October 22, 2023.
\item
